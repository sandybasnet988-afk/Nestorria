  ...
  return (
    <div className='bg-gradient-to-r from-[#fffbee] to-white'>
      <div className='mx-auto max-w-[1440px] flex flex-col md:flex-row'>
        {/*side bar*/}
        <div className='max-md:flexCenter flex flex-col justify-between bg-white sm:m-3 md:min-h-[97vh] rounded-xl shadow '>
          <div className='flex flex-col gap-y-6 max-md:items-center md:flex-col md:pt-5'>
            ...
            <div className='w-full flex justify-between md:flex-col'>
              ...
              <div className='md:hidden flex items-center gap-3 md:bg-primary rounded-b-xl p-2 pl-5 lg:pl-10 md:mt-10'>
               <UserButton
                ...
                />
                <div className='text-sm font-semibold text-gray-800 capital'>
            ...
            <div className='flex md:flex-col md:gap-x-5 gap-y-8 md:mt-4'>
              {navItems.map(Link =>(
                ...
                className={({isActive})=> isActive ? "flexStart gap-x-2 p-5 lg:pl-12 bold-13 sm:!text-sm cursor-pointer h-10 bg-secondary/10 max-md:border-b-4 md:border-r-4 border-secondary" : "flexStart gap-x-2 lg:pl-12 p-5 b0ld-13 sm:!text-sm cursor-pointer h-10 rounded_xl"}
                >
