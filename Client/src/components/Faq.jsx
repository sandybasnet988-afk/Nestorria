...
const [openIndex, setOpenIndex] = React.useState(null)
    const faqsData = [
        ...
        },
        {
            ...
            answer: 'Every property is accessible by area - bo extra effortrequired.'
        },
        {
            question: 'Real Estate Powered',
            answer: 'Backend using trusted property data - no extra effort required.'
        },
        {
     ...
     <div className='flex flex-col gap-y-12 xl:flex-row'>
       ...
       <div className="flex-1">
        <div className='relative rounded-3xl overflow-hidden inline-block'>
          ...
          <div className='absolute top-5 left-5 right-5 bg-white p-3 rounded-2x1 flex items-center gap-4 z-10'>
