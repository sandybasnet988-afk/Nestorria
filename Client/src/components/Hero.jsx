...
const Hero = () => {
  return (
   <section className="h-screen w-screen bg-[url('/src/assets/bg.png')] bg-cover bg-center bg-no-repeat">
    <div className='max-pad-container h-screen w-screen'>
      {/*overlay*/}
        ...
        <div className='flex flex-col mt-12 text-white'>
          <button className='max-w-80 flex items-center space-x-3 border border-white medium-13 rounded-full px-4 pr-0.5 py-1 cursor-pointer'>
           ...
           <span className='flexcenter size-6 p-1 rounded-full bg-white'>
            ...
            <h2 className='h2 cpitalize leading-tight mt-3 my-2 text-white'>Explore <span className='bg-gradient-to-r from-secondary to-white bg-clip-text text-transparent'>exceptional properties </span>
             located in stunning surrounding</h2>
        </div>
        {/*search/booking form*/}
        <form className='bg-white text-gray-500 rounded-lg px-6 py-3 flex flex-col lg:flex-row gap-4 lg:gap-x-8 max-w-sm lg:max-w-full ring-1 ring-slate-900/5 relative'>
