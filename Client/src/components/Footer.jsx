        ...
        <footer className='pt-16 xl:pt-20 w-full text-gray-500 bg-[#fffbee]'>
          ...
          <div className=' flex mb-4'>
            ...
            <img src={assets.logoImg} alt="logoimg" className={`h-11`} />
                    ...
                    <p className='text-sm'>
                       Experience modern living through well-presemted properties, professional support, and thoughtfully designed spaces.
                    </p>
                ...
                <div className="max-w-80">
                    <p className='h4 text-blacl/80'>SUPPORT</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center border pl-4 gap-2 bg-white border-gray-500/30 h-[46px] rounded-full overflow-hidden-max-w-md w-full mt-6 '>
                        <input type="text" className='w-full h-full outline-none text-sm text-geay-500' placeholder='Your email' />
