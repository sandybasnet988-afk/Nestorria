...
const PropertyDetails = () => {
  ...
  return (
    property && (
        ...
        <div className='bg-gradient-to-r from-[#fffbee] to-white py-16 pt-26'>
                    ...
                    <div className='flex flex-col xl:flex-row gap-8 mt-6'>
                         ...
                         <div className='p-4 flex-2 rounded-xl border border-slate-900/10'>
                            ...
                            <div className=' flex justify-between items-start my-1'>
                                ...
                                <img src={assets.star} alt="starIcom" width={18} />
                                <img src={assets.star} alt="starIcom" width={18} />
                                <img src={assets.star} alt="starIcom" width={18} />
                                <img src={assets.star} alt="starIcom" width={18} />
                                <img src={assets.star} alt="starIcom" width={18} />
                            ...
                            {/* form | check AVAIBILITY*/}
                             <form className=' text-gray-500 bg-secondary/10 rounded-lg px-6 py-3 flex flex-col lg:flex-row gap-4  max-w-sm lg:max-w-full ring-1 ring-slate-900/5 relative mt-10'>
                                      ...
                                      <div className='flex flex-col w-full'>
                                        ...
                                        <input type="date" id='checkIn' className='rounded bg-secondary/10 border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none' />
                                      </div>
                                       <div className='flex flex-col w-full'>
                                        <div className='flex items-center gap-2'>
                                          <img src={assets.calendar} alt="calenderIcon" width={20} />
